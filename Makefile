...
.PHONY: install
install: vim neovim tmux git ctags ruby fish termite
...
.PHONY: neovim
neovim: $(VIMRC) $(VIM_DIR)
ifdef NEOVIM
	@echo ""
	@echo "==> Installing neovim files"
	$(LINK) $(VIM_DIR) $(CONFIG)/nvim
...
clean: clean_vim clean_tmux clean_git clean_ctags\
	clean_ruby clean_fish clean_termite clean_neovim
